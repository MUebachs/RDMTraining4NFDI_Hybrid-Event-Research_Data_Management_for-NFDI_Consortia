...
# Module 2: Open Science
 ...
 - [ ] Write a brief profile of a tool or initiative that can be used to promote or implement open science. This could be a tool or initiative that you know about or use, or that your institution offers or is involved in. The minimum information required is: (1) Name of the tool/initiative, (2) Link, (3) Assignment to the step in the research data life cycle, and (4) One to two sentences/key points on the extent to which it supports open science. This is a great opportunity to team up with others from your consortium! You can start collaborating now, or plan exchange time during the asynchronous homework phase (24 November to 5 December). If you’d rather, you’re also welcome to work independently.
...
# Module 3: Python for Advanced
 ...
 - **Titles and URLs:**
   ...
   - Notebook b: [Merge Data Frames With Pandas (EN)](https://github.com/foerstner-lab/Bits_and_pieces_for_the_carpentries_workshops/blob/main/python/Python_pandas/Pandas_merging_apply_groupby-en.ipynb) 
 ...
 **Section(s)**
 ...
 - [ ] **Slide 85:** Based on the following criteria, use [re3data](https://www.re3data.org/) to find a trustworthy repository in your field of research: does the repository provide: (1) open access to its data; (2) clearly stated terms of use and data licenses; (3) policies to help researchers determine whether their data needs will be met; (4) Digital Object Identifiers (DOIs); and (5) certification or support for a recognized repository standard?
 - [ ] For each section of this module, or for the module as a whole, write down the three most important things you have learned.
